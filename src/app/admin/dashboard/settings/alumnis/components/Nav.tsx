  ...
  return (
    <>
      <nav className="w-full h-20 pt-10 pr-10 flex justify-end items-center">
        <div
          className="hover:bg-blue-gray-50 ease-in-out transition-all  duration-150 p-2 cursor-pointer rounded-full"
          onClick={handleOpen}
        >
          <PersonAddAlt1Icon className="text-gray-800 dark:text-white " />
        </div>
      </nav>

...
function Footer() {
    ...
    return (
        <footer className="flex w-full bg-[#3a0808] flex-row flex-wrap items-center flex-col md:flex-row md:px-28 justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between"
            style={{

    ...
    try {
        return (
            <div className={`pt-24 text-white w-full md:px-20 min-h-svh h-full flex-col md:flex-row justify-center items-center relative py-20 bg-[#3a0808] flex md:justify-between ${scroll ? 'md:min-h-[200vh]' : 'md:min-h-svh'}`} style={{
                backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.34), rgba(0, 0, 0, 0.35)), linear-gradient(49deg, rgb(55 27 35 / 59%) 0%, rgb(62 24 29 / 30%) 12%, rgb(12 6 5 / 53%) 80%)`
            }}>
                ...
                <div className='mt-24  md:mt-0 flex w-full lg:w-[80%] md:w-[50%] rounded-full min-h-svh h-full px-10 lg:px-16 lg:pr-0 xl:py-16 flex-col justify-center gap-14 md:gap-24 xl:justify-between'>
